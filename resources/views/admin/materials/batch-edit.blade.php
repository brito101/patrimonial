...
@section('title', '- Edição de Materiais em lote')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-box"></i> Editar Materiais em lote ({{ count($materials) }})</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <form method="POST" action="{{ route('admin.materials.batch.update') }}">
                            @method('PUT')
                            <input type="hidden" name="ids" value="{{ join(',', $materials) }}">
                            @csrf
                            <div class="card-body">
